...
describe("FundMe", function () {
    ...
    beforeEach(async function () {
        // deploy FundMe contract using Hardhat-deploy => FundMe deployment will come along with our 00 and 01 deploy scripts in deploy folder.
        ...
        // eveyrthing gets executed in the deploy folder with this.
        ...
        mockV3Aggregator = await ethers.getContract(
            "MockV3Aggregator",
            deployer
        ) //address where this gets deployed
    })
